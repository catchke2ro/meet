 ...
 */
class QuestionCategory extends BaseModel implements CategoryInterface, DataTableModelInterface {
	...
	public function toDataTableArray(): array {
		...
		$orgTypes = array_map(function (QuestionCategoryOrgType $orgType) {
			return OrganizationType::getList()[$orgType->orgTypeId] ?? null;
		}, $this->orgTypes ?: []);
	...
	public function getDataTableActions(): array {
		return [
			'items'  => '<a href="/admin/question-items?categoryId=' . $this->id . '" class="fa fa-list" title="Kérdések"></a>',
