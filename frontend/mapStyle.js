export default {
	...
	"sources": {
		"openmaptiles": {
			"type": "vector",
			"url": "https://api.maptiler.com/tiles/v3/tiles.json?key=jADF7V9AR3eUyKhE9eJm"
		},
	...
	"glyphs": "https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=jADF7V9AR3eUyKhE9eJm",
	"layers": [
		{
			"id": "background",
			"type": "background",
		...
		},
		{
			...
			"layout": {
				"text-field": "{name}",
				"text-font": ["Roboto Regular", "Nunito Regular"],
				"text-max-width": 5,
				"text-size": 12,
				"symbol-placement": "line",
				"visibility": "none"
		...
		},
		{
			...
			"layout": {
				...
				"text-anchor": "top",
				"text-field": "{name}",
				"text-font": ["Roboto Condensed Italic", "Nunito Italic"],
				"text-max-width": 9,
				"text-offset": [0, 0.6],
				"text-size": 12,
				"visibility": "none"
		...
		},
		{
			...
			"layout": {
				...
				"text-anchor": "bottom",
				"text-field": "{name_en}",
				"text-font": ["Roboto Medium", "Nunito Bold"],
				"text-max-width": 8,
				"text-offset": [0, 0],
