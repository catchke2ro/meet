...
use app\modules\meet\components\TimestampBehavior;
...
class User extends ActiveRecord implements IdentityInterface, DataTableModelInterface {
	...
	public function getDataTableActions(): array {
		return [
			'edit'   => '<a href="/meet/users/edit?id=' . $this->id . '" class="fa fa-pencil" title="Szereksztés"></a>',
			'delete' => '<a href="/meet/users/delete?id=' . $this->id . '" class="fa fa-trash" title="Szereksztés" onclick="return confirm(\'Biztos törlöd?\')"></a>',
		];
	}
