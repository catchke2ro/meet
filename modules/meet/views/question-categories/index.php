	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<a href="/meet/question-categories/create" class="btn btn-primary pull-right">Új kategória</a>
			</div>
			<div class="card-body">
				<table class="dataTable table table-bordered table-hover" data-ajax="/meet/question-categories" data-order='[[2,"asc"]]'>
					<thead>
					<tr>
