	...
	<div>
		...
		<div class="actions">
			<a class="moveUpLink fa fa-arrow-up"
			   href="/admin/commitment-categories/reorder/<?=$category->id;?>/-1"
			   title="Mozgatás fel"
			   target="_blank"></a>
