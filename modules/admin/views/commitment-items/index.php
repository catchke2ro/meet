	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				...
				<a href="/admin/commitment-items/create?categoryId=<?=$category->id;?>" class="btn btn-primary pull-right">Új Vállalás</a>
			</div>
			<div class="card-body">
				<table class="dataTable table table-bordered table-hover" data-ajax="/admin/commitment-items?categoryId=<?=$category->id;?>" data-order='[[2,"asc"]]'>
					<thead>
					<tr>
