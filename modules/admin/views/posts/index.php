	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<a href="/admin/posts/create" class="btn btn-primary pull-right">Új bejegyzés</a>
			</div>
			<div class="card-body">
				<table class="dataTable table table-bordered table-hover" data-ajax="/admin/posts" data-order='[[2,"asc"]]'>
					<thead>
					<tr>
