	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				...
				<h6>Kérdés: <?=$item->name;?> [<a href="/admin/question-items?categoryId=<?=$item->category->id;?>">Vissza a kérdésekhez</a>]</h6>
				<a href="/admin/question-options/create?itemId=<?=$item->id;?>" class="btn btn-primary pull-right">Új opció</a>
			</div>
			<div class="card-body">
				<table class="dataTable table table-bordered table-hover" data-ajax="/admin/question-options?itemId=<?=$item->id;?>" data-order='[[2,"asc"]]'>
					<thead>
					<tr>
