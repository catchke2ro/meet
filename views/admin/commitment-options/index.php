	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				...
				<h6>Vállalás: <?=$item->name;?> [<a href="/admin/commitment-items/<?=$item->category->id;?>">Vissza a vállalásokhez</a>]</h6>
				<a href="/admin/commitment-options/create/<?=$item->id;?>" class="btn btn-primary pull-right">Új opció</a>
			</div>
			<div class="card-body">
				<table class="dataTable table table-bordered table-hover" data-ajax="/admin/commitment-options/<?=$item->id;?>" data-order='[[2,"asc"]]'>
					<thead>
					<tr>
