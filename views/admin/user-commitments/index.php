...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			<div class="card-body">
				<table class="dataTable table table-bordered table-hover" data-ajax="/admin/user-commitments" data-order='[[1,"desc"]]'>
					<thead>
					<tr>
						<th data-data="id">ID</th>
						<th data-data="date">Dátum</th>
						<th data-data="user" data-orderable="1">Felhasználó</th>
