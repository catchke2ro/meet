...
$referer = $organization->meetReferee;
?>
...
<table class="header">
	<tr>
		...
		<td class="quote"><p>„Hasonló a mennyek országa a mustármaghoz, amelyet fog az ember, és elvet szántóföldjébe. Ez kisebb ugyan minden magnál, de amikor felnő, nagyobb
				minden veteménynél, és fává lesz, úgyhogy eljönnek az égi madarak és fészket raknak ágai között.”<br /> (Mt 13,31-32)</p></td>
	</tr>
</table>
<h1><?=$organization->name;?></h1>
<h2><?=$organization->getAddress()?->city ? $organization->getAddress()?->city . ', ' : '';?><?=date('Y. m. d.');?></h2>

<br />

<div class="content">
	<p>Közösségünk a mai napon csatlakozott a <strong>Műveld és őrizd! Evangélikus Egyházi Teremtésvédelmi programhoz</strong>, mellyel az alábbi teremtésvédelmi vállalást tettük:
	</p>
	<ul>
	...
	<p>Vállaljuk továbbá, hogy a Műveld és őrizd! Evangélikus Egyházi Teremtésvédelmi programot saját közösségi felületeinken és csatornáinkon keresztül hirdetjük más közösségek
		számára is.</p>
...
<table class="signs">
	<tr>
		<td>
			<div class="signBlock">
				...
				<span class="name"><?=$pastor ? $pastor->name : '&nbsp;';?></span><br />
		...
		<td>
			<div class="signBlock">
				<span class="dots"></span>
				<span class="name"><?=$superintendent ? $superintendent->name : '&nbsp;';?></span><br />
	...
	<tr>
		<td colspan="2">
			<div class="signBlock">
				<span class="dots"></span>
				<span class="name"><?=$referer ? $referer->name : '&nbsp;';?></span><br />
