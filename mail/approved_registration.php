...
<p>Örömmel tájékoztatunk, hogy regisztrációd véglegesítésre került, így szeretettel köszöntünk a program referensei között, és kívánjuk Isten áldását a <?=$organization->nev;?> szervezetben végzett szolgálatodra.</p>

<p>
	Mostantól a megadott email címeddel és jelszavaddal be tudsz jelentkezni a MEET online tervezőfelületére, ahol lehetőséged nyílik megtervezni és nyomon követni az általad képviselt gyülekezet teremtésvédelmi programját, munkáját.<br />
